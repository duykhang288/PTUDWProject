...
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container-fluid">
    <a class="navbar-brand"  to="/" href="/">
        <img src="https://cdn-icons-png.flaticon.com/512/438/438560.png" alt="Yame.vn" style="width: 66px;">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <a  to="/" class="nav-link active " href="/" aria-current="page">
            Trang Chủ
          </a>
        </li>
        <li class="nav-item   rounded-pill">
          <router-link to="/info" class="nav-link active">Về chúng tôi</router-link>
        </li>
      ...
      <form class="d-flex flex-mb">
        ...
        <button class="btn btn-light rounded" type="button" @click="slideSearch()"><i class="bi bi-search icon"></i></button>
      </form>
         ...
         <div class="wrapper_cart">
             <div class="cart_link" id="cart_link">
                <div class="card card-body  cart-info" > 
                    <div class="cart-list">
                        <h4 class="text-dark">Giỏ hàng</h4>
                        ...
                        <div class="item_cart" v-for="item in carts">
                            ...
                            <div class="item-name">
                                <span class="text-dark name-product">{{item.title}}</span>
                            </div>
                            <div class="item-price">
                                <span class="text-dark price-product">{{item.price}}$</span>
                            </div>
                            <div class="item-quantity">
                                <span class="text-dark quantity-product">x{{item.quantity}}</span>
                            </div>
                        </div>   
                         </router-link>          
                  </div>
                  <div class="footer-cart">
                          <span class="text-dark">Có <span class="lenghtCart">{{getlengthcarts }}</span> Sản phẩm trong giỏ hàng </span>
                          <button class="btn btn-dark" type="button" @click="gotocart">Xem giỏ hàng</button>
                  </div>
            </div>
          </div>
              ...
              <div class="collapse user_link" id="user">
                <div class="card card-body connect-shop">
                  <router-link to="/profile" class="text-dark">Trang cá nhân</router-link>
                   <router-link to="/admin" class="text-dark" >Admin</router-link>
