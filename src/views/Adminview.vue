...
<template>
        ...
        <div class="main_admin d-flex " style="margin-top:30px; margin-left: 100px;margin-right: 100px; border-radius: 40px; background-color:#e9ecef ; padding: 50px;">
                ...
                <div class="user_heading">
                    ...
                    <div class="list_item_user  d-flex" id="user">
                        <ListUser :users="users"  :refeshlist="getall" v-model:activeUser="activeUser"></ListUser>
                           <div class="card_product  h-100  text-dark" style="padding: 10px;" v-if="getindexuser">  
            ...
            <div class="list_products">
                <div class="product_heading">
                    ...
                    <div class="card_product  h-100  text-dark" style="padding: 10px;" v-if="getindex">  
