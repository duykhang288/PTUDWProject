...
<template>
  ...
  <div class="container py-5 h-100">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-12">
        <div class="card card-registration card-registration-2" style="border-radius: 15px; border: 0px !important;">
          <div class="card-body p-0">
            <div class="row g-0">
              <div class="col-lg-8 shadow " style="background-color: bisque; border-top-left-radius: 40px; border-bottom-left-radius: 40px; border: 0px !important;">
                <div class="p-5">
              ...
              <div class="col-lg-4 bg-grey shadow-lg">
                <div class="p-5">
