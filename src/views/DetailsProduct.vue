...
<template>
    ...
    <toastsVue></toastsVue>
    <div class="heading ">
        <div class="title shadow" style="background-color: #e9ecef; border-radius: 20px;">
        <h2 class="text-dark text-center" style="padding-left: 20px;">Chi tiết sản phẩm</h2>
        </div>
    </div>
    <div class="container mx-auto shadow" style="padding: 30px; background-color: #e9ecef; margin-top: 50px; margin-bottom: 50px; border-radius: 20px;" >
    <div class="wrapper ">
    ...
    <div class="img_product col ">
        ...
        <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleControls" data-bs-slide="next">
            ...
            <div class="info_product col" style="margin-left: 20px;">
                ...
                <div class="btn_product m-2 ">   
                        <button type="submit" class="btn btn-dark" style="width:150px; margin-right: 50px;" @click="getidcart()">Mua Ngay</button>
                     <router-link to="/">
